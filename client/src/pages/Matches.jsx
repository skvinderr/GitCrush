    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-4 bg-bg-base border-t border-bg-border shrink-0 flex flex-col md:flex-row gap-3">
          {match.dateRepoUrl ? (
            <a href={match.dateRepoUrl} target="_blank" rel="noreferrer" className="flex-1 btn-primary py-3.5 shadow-lg shadow-brand-pink/20 bg-brand-pink/10 border border-brand-pink text-brand-pink hover:bg-brand-pink/20 text-center font-bold text-sm flex items-center justify-center gap-2">
            ...
            <button 
               className="flex-1 btn-primary py-3.5 shadow-lg shadow-brand-pink/20" 
               onClick={async () => {
                 try {
